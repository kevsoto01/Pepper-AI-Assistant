...
class LocalUIRenderingManager:
    ...
    def load_initial_values(self):
        ...
        use_pepper = self.get_config_value("pepper", "should_use")
        use_web_ui = self.get_config_value("web_ui", "should_use")
        volume = self.get_config_value("audio", "volume")

        writer_llm = self.get_config_value("writer_llm", "model")
        judge_llm = self.get_config_value("judge_llm", "model")
    ...
    def on_use_pepper_changed(self):
        ...
        self.set_config_value("pepper", "should_use", value)
    ...
    def on_use_web_ui_changed(self):
        ...
        self.set_config_value("web_ui", "should_use", value)
